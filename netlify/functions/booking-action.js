...
exports.handler = async (event) => {
  ...
  if (action === "request") {
    ...
    const typeLabel = bookingType === "primary" ? "Primary Lab Booking" : "Secondary Lab Booking";
  ...
  if (action === "approve") {
    ...
    const storageKeyFn = (wkk) => bookingType === "primary" ? `primary_${lab}_${wkk}` : `bookings_${lab}_${wkk}`;
